...
profile=brief for triage. gdb_evaluate side_effects=allow permits inferior calls or assignments in one request. Query a returned operation_id after timeout. Close when done.";
